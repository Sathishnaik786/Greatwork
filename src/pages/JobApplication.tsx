...
const JobApplication = () => {
    ...
    return (
        <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-white min-h-screen">
            <SEO
                title="Careers"
                description="Join Great Work Academy. We are looking for talented individuals to help us build the future of digital solutions."
                keywords="careers, job application, greatwork academy jobs, hire me, digital agency careers"
            />
